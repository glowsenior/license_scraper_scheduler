...
class LicenseCrawler:
    ...
    def __init__(self):
        ...
        self.output_file = 'results/results1.csv'
        self.csv_lock = Lock()
        ...
        self.target_type = "289"  # "Physicians and Surgeons"
        self.payload = {
            'boardCode': '0',
    ...
    def fetch_cities(self):
        ...
        # Extract all the cities from Advanced search page and then make name value as per format.
