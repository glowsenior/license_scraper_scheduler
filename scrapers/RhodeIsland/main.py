...
class LicenseCrawler:
    def __init__(self):
        ...
        self.csv_lock = Lock()
        self.profession_name = 'Physician'
        self.license_type_names = ['Allopathic Physician (MD)', 'Osteopathic Physician (DO)']
        ...
        self.headers = {
            ...
            'origin': 'https://healthri.mylicense.com',
            'priority': 'u=0, i',
            'referer': 'https://healthri.mylicense.com/verification/Search.aspx?facility=N&SubmitComplaint=Y',
    ...
    def run_home_page_search(self, session, viewstate, eventvalidation, view_state_generator, license_type_name="",
        ...
        while retries:
            retries -= 1
            try:
                response = session.post(url, headers=self.headers, data=data, params=params)
                if response.status_code != 200:
    ...
    def navigate_to_listing_page(self, session, viewstate, eventvalidation, viewstate_generator, target, page_number):
        ...
        logger.info(f"Navigate to Listing Page: {page_number} | {target}")

        try:
            url = 'https://healthri.mylicense.com/verification/SearchResults.aspx'
    ...
    def get_detail_page(self, session, url):
        """Fetching detail page of a licensee using url"""
    ...
    def extract_form_data(self, html_content):
        ...
        try:
            ...
            eventvalidation = soup.find('input', {'id': '__EVENTVALIDATION'})['value'] if soup.find('input', {
    ...
    def process_license_number(self, index, l_num, total_count):
        ...
        try:
            ...
            base_url = "https://healthri.mylicense.com/verification/"
        ...
        with ThreadPoolExecutor(max_workers=1) as executor:
            ...
            for future in as_completed(futures):
                ...
                try:
                    ...
                    logger.error(f"Task generated an exception: {e} | {l_num}")
